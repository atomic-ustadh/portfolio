...
function Home() {
  return (
    <>
      <SEO title="Home" description="atomicustadh - Full Stack Developer portfolio with blog" />
      <div
      ...
      <div className="relative z-10 min-h-screen">
        <div className="min-h-screen flex items-center justify-center px-4">
          <div className="text-center text-white max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-bold mb-4">atomicustadh</h1>
            <p className="text-xl md:text-2xl mb-2 text-gray-200">Full Stack Developer</p>
        ...
        <div className="bg-white">
          <section id="about" className="max-w-6xl mx-auto px-4 py-20">
            ...
            <div className="max-w-3xl mx-auto text-lg text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                Always excited to take on new challenges and build impactful products.
              </p>
            </div>
          </section>

          <section id="projects" className="max-w-6xl mx-auto px-4 py-20 bg-gray-50">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">Projects</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                <div key={i} className="border border-gray-200 p-6 hover:shadow-lg transition-shadow">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="px-2 py-1 bg-gray-100 text-sm">React</span>
                    <span className="px-2 py-1 bg-gray-100 text-sm">Node.js</span>
                    <span className="px-2 py-1 bg-gray-100 text-sm">Firebase</span>
                  </div>
                  <div className="flex gap-4">
                    <a href="#" className="text-black hover:underline">Live Demo</a>
          ...
          <section id="skills" className="max-w-6xl mx-auto px-4 py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { category: 'Frontend', skills: ['React', 'JavaScript', 'TypeScript', 'Tailwind CSS', 'HTML/CSS'] },
                { category: 'Backend', skills: ['Node.js', 'Express', 'Firebase', 'REST APIs'] },
                { category: 'Tools', skills: ['Git', 'GitHub', 'VS Code', 'Netlify', 'Figma'] },
              ].map((group) => (
                <div key={group.category} className="border border-gray-200 p-6">
